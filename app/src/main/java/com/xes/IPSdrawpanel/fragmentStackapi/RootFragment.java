...
public abstract class RootFragment extends Fragment implements OnNewIntent {
	...
	public void open(@NonNull RootFragment fragment) {
	 ...
	 public void backfram() {
	        getRoot().manager.onBackPressed();
	    }
	/**
	...
	/**
	 * open a new Fragment,And transfer parameters with bundle andr set
	 * StackMode Like this
	 * 
	 * <pre>
	 * {
	 ...
	 *            bundle
	 * @param stackMode
	 *            stackMode,{@link StackManager#STANDARD} or more
	 */
