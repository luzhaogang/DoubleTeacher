...
public class FragmentStack {
    private ArrayList<ArrayList<RootFragment>> stackList = new ArrayList<ArrayList<RootFragment>>();
    private ArrayList<RootFragment> stack;
    private CloseFragment listener;

    public FragmentStack() {
        if (stack == null) {
            stack = new ArrayList<RootFragment>();
        }
        stackList.add(stack);
    }
    ...
    public void putSingleInstance(RootFragment fragment) {
        ArrayList<RootFragment> frags = new ArrayList<RootFragment>();
        frags.add(fragment);
        stackList.add(frags);
    }
