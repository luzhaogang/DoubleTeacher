...
public class NumberProgressBar extends View {
    ...
    private void calculateDrawRectF(){
        mCurrentDrawText = String.format("%d" ,Long.valueOf( getProgress())*100/Long.valueOf( getMax())); 
    //    Log.e(Utility.LOG_TAG, "getProgress()*100/getMax() :" + Long.valueOf( getProgress())*100/Long.valueOf( getMax()));
