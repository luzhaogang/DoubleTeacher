...
public class RoundedLetterView extends View {
    ...
    private static int DEFAULT_BACKGROUND_COLOR = Color.RED;
    private static int DEFAULT_VIEW_SIZE = 240;
    private static float DEFAULT_TITLE_SIZE = 25f;
    private static String DEFAULT_TITLE = "1";
    ...
    public RoundedLetterView(Context context,int color) {
        super(context);
        DEFAULT_VIEW_SIZE = (int) context.getResources().getDimension(R.dimen.rounded_letter_view);
        DEFAULT_TITLE_SIZE= (Float) context.getResources().getDimension(R.dimen.fontsize_14);
        init(null, 0,color);
    }
    ...
    private void init(AttributeSet attrs, int defStyle,int color) {
