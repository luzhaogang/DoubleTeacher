...
public abstract class ChartUtils {
    ...
    public static final int COLOR_1 = Color.parseColor("#66cc52");
    public static final int COLOR_2 = Color.parseColor("#faae57");
    public static final int COLOR_3 = Color.parseColor("#fa7064");
    public static final int COLOR_4 = Color.parseColor("#3da7f2");
    public static final int COLOR_5 = Color.parseColor("#544ec9");
    public static final int COLOR_6 = Color.parseColor("#e345a6");
    public static final int[] COLORS = new int[]{COLOR_1, COLOR_2, COLOR_3, COLOR_4, COLOR_5,COLOR_6};
