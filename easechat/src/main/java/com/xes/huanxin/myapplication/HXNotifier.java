 ...
 */
package com.xes.huanxin.myapplication;
...
public class HXNotifier {
     ...
     * @param message
     */
    public synchronized void onNewMsg(EMMessage message,Boolean isMsg) {
        ...
        if (!EasyUtils.isAppRunningForeground(appContext)) {
            ...
            sendNotification(message, false,isMsg);
        } else {
            sendNotification(message, true,isMsg);
    ...
    protected void sendNotification (EMMessage message, boolean isForeground,Boolean isMsg){
        sendNotification(message, isForeground, true,isMsg);
    }
     ...
     * @param message
     */
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease,Boolean isMsg) {
        ...
        try {
            ...
            if (notificationInfoProvider != null) {
                String customNotifyText = notificationInfoProvider.getDisplayedText(message,isMsg);
                String customCotentTitle = notificationInfoProvider.getTitle(message,isMsg);
                if (customNotifyText != null){
                    // 设置自定义的状态栏提示内容
                    notifyText = customNotifyText;
                    //notifyText = message.getStringAttribute("msg");
                }
    ...
    public interface HXNotificationInfoProvider {
         ...
         * @return null为使用默认
         */
        String getDisplayedText(EMMessage message,Boolean isMsg);
         ...
         * @return null为使用默认
         */
        String getTitle(EMMessage message,Boolean isMsg);
